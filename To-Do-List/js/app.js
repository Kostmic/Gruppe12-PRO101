...
function addToDo(toDo, id, trash, currentPosition, username) {
  ...
  const item =
    '<div class="item" draggable="true" id="' +
    id +
    '"><i class="fa fa-info-circle" job="info"></i> <p class="text">' +
    toDo +
    '<p class="authorText">Added by: ' +
    username +
    '</p></p><i class="fa fa-trash-o de" job="delete" id="' +
    id +
    '"></i></div>';
